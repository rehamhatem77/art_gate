...
//         >
//             <div className="flex items-center gap-3 w-full min-w-lg "></div>

//             <div className="flex items-center gap-3 md:gap-5 relative w-full">
...
export default function Header() {
    ...
    return (
        <header
            className="p-5 h-20 gap-5 border-b border-gray-200  sm:px-5 flex items-center justify-between
                           bg-[var(--bg-lighter)] backdrop-blur-md sticky top-0 z-20 "
        >
            <div className="flex-1 items-center gap-3 w-full min-w-lg "></div>
            <div className="flex-2 items-center gap-3 md:gap-5 relative w-full max-w-lg">
                <div className="relative flex-1 min-w-md">
                    <FiSearch className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--secondary)] text-lg" />
                    <input
                        type="text"
...
"
            ...
            <div className="flex-1 items-center justify-end  gap-3 md:gap-5 relative w-full">
