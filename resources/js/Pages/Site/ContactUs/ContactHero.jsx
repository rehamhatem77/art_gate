...
export default function ContactHero({ hero }) {
  return (
    ...
    >
      ...
      >
        <img
          src={hero?.image ? getImage(hero.image) : "https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=2070&auto=format&fit=crop"}
          alt="ArtGateContact"
          ...
          >
            ...
            <div className="mt-10">
              <button
                onClick={() =>
                  window.open(
                    `https://wa.me/${hero?.whatsapp}?text=${encodeURIComponent(
